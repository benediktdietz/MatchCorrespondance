...
def sampleTDFs(snap1):
    ...
    non0pix1 = np.array(np.nonzero(depthImg1[frame_size:-frame_size,frame_size:-frame_size]))
    ...
    np.save('/media/drzadmin/DATA/recon_files/tdfs_reconstruction_' + str(snap1) + '.npy', samples)
    np.save('/media/drzadmin/DATA/recon_files/meta_reconstruction_' + str(snap1) + '.npy', samples_meta)

...
with tf.Session(config=config) as sess:
    ...
    for i in range(0,iterations):
        ...
        if err95 < .5:
            ...
            tdf1_rec = np.load(recpath + 'tdfs_reconstruction_5.npy')
            p1_info = np.load(recpath + 'meta_reconstruction_5.npy')
            
            tdf2_rec = np.load(recpath + 'tdfs_reconstruction_6.npy')
            p2_info = np.load(recpath + 'meta_reconstruction_6.npy')
